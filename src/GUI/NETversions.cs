...
namespace DrunkenBakery.OWAtray.GUI
{
	...
	public partial class NeTversions : Form
	{
		public NeTversions()
		{
			...
			// Clear list
			lvStatus.Columns.Add(Resources.NeTversions_NeTversions_Major_Version, (lvStatus.Width / 2), HorizontalAlignment.Left);
			lvStatus.Columns.Add(Resources.NeTversions_NeTversions_Revision, (lvStatus.Width / 2) - 3, HorizontalAlignment.Left);
