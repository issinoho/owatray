	...
	public class FlatFile
	{
			...
			set
			{
				if (value)
				{
					...
					if (pVerbose)
					{
						AddEntry("");
						AddEntry("--------------------------------------------------------------------------------");
						AddEntry(OWAtray.Logging_Started);
					}
				}
				else
				{
					if (pVerbose)
					{
						AddEntry(OWAtray.Logging_Stopped);
						AddEntry("--------------------------------------------------------------------------------");
						AddEntry("");
					}
		...
		public bool DateOn
		{
			...
			set
			{
				...
				if (pVerbose)
				{
					if (pDateOn)
					{
						AddEntry(OWAtray.Date_stamping_switched_on);
					}
					else
					{
						AddEntry(OWAtray.Date_stamping_switched_off);
					}
				}
			}
		}
		...
		public bool LimitSize
		{
			...
			set
			{
				...
				if (pVerbose)
				{
					if (pLimitSize)
					{
						AddEntry(OWAtray.Log_files_are_size_limited + " " + pMaxSize + OWAtray.Mb);
					}
					else
					{
						AddEntry(OWAtray.Log_files_are_NOT_size);
					}
				}
			}
		}
		...
		public string LogFile
		{
			...
			set
			{
				...
				if (pVerbose)
				{
					AddEntry(OWAtray.Log_file_is + " " + pLogFile);
				}
			}
		}
		...
		public bool Scavenge
		{
			...
			set
			{
				...
				if (pVerbose)
				{
					if (pScavenge)
					{
						AddEntry(OWAtray.Log_files_will_be_scavenged + " " + pScavengeDays + " " + OWAtray.days_or + " " + pScavengeSize + OWAtray.Mb_total_size);
					}
					else
					{
						AddEntry(OWAtray.Log_files_will_NOT_be);
					}
				}
			}
		}
