...
!define PRODUCT_VERSION "3.0.4666.39487"
...
Section "MainSection" SEC01
  ...
  File "..\bin\alert.ico"
  File "..\bin\DrunkenBakery.OWAtray.Audio.dll"
  File "..\bin\DrunkenBakery.OWAtray.Connections.Abstract.dll"
  File "..\bin\DrunkenBakery.OWAtray.Connections.EWS.dll"
  File "..\bin\DrunkenBakery.OWAtray.Connections.Proxy.dll"
  File "..\bin\DrunkenBakery.OWAtray.Framework.dll"
  File "..\bin\DrunkenBakery.OWAtray.Growl.dll"
  File "..\bin\DrunkenBakery.OWAtray.GUI.exe"
  File "..\bin\DrunkenBakery.OWAtray.GUI.exe.config"
  File "..\bin\DrunkenBakery.OWAtray.Logging.dll"
  File "..\bin\DrunkenBakery.OWAtray.ShellIntegration.exe"
  File "..\bin\DrunkenBakery.OWAtray.ShellIntegration.exe.config"
  File "..\bin\DrunkenBakery.OWAtray.Snarl.dll"
  File "..\bin\email.ico"
  File "..\bin\email.png"
